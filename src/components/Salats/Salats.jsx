import salads from "../mock/saladsData";
import "./Salats_module.scss";
...
export default function Salats() {
  ...
  return (
    <>
      <div className="products__title">Салаты</div>
        ...
        {salads.map((v) => (
          <div key={v.id} className="product__card">
            ...
            <div className="product__prices">
              ...
              <Button sx={button} onClick={() => handleOpen(v.id)}>
                Выбрать
              </Button>
              <Modal
                open={open}
              ...
              >
                <Box sx={style}>
                  {salads.map((salad) => {
                    if (currentProduct.id === salad.id) {
                      return (
                        <div className="modal" key={salad.id}>
                          <Typography id="modal-modal-title" variant="img">
                            {" "}
                            <img src={salad.img} alt="ghjgh" />
                          </Typography>
                          <Typography sx={main}>
                            <Typography
                          ...
                          <Typography sx={sty} id="modal-modal-description">
                            ...
                            <Typography
                              ...
                              open={open}
                            >
                              Добавить{currentProduct.quantity * salad.price}
                            </Typography>
                          </Typography>
                        </div>
                      );

import pastas from "../mock/pastaData";
import "./Pasta_module.scss";
...
export default function Pasta() {
  ...
  return (
    <>
      <div className="products__title">Паста</div>
      <div className="products__container">
        {pastas.map((v) => (
            <div className="product__card">
              <div className="about__product">
                <img src={v.imgPasta} alt="" />
              ...
              <div className="product__prices">
                ...
                <Modal open={open} onClose={handleClose} aria-labelledby="modal-modal-title" aria-describedby="modal-modal-description">
                  <Box sx={style}>
                    {pastas.map((pasta) => {
                      if (currentProduct.id === pasta.id) {
                        return (
                          <div className="modal" key={pasta.id}>
                            <Typography id="modal-modal-title" variant="img"><img src={pasta.imgPasta} alt="ghjgh"/></Typography>
                            <Typography sx={main}>
                              <Typography id="modal-modal-title" sx={title} variant="p">{pasta.name}</Typography><br></br><br></br>
                              <Typography id="modal-modal-description" variant="p" sx={subtitle}> {pasta.comment}</Typography></Typography>
                            <Typography sx={sty} id="modal-modal-description">
                              ...
                              <Typography sx={styl} className="totalPrice" onClick={() => addToOrders(pasta.name, currentProduct.quantity, pasta.price, pasta.comment, pasta.id)} open={open}> Добавить {currentProduct.quantity * pasta.price}</Typography>
                            </Typography>
                          </div>)}
                      return null;
                    })}
